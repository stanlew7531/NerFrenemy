...
import json
from grasping.pytorch_6dof_graspnet.utils import sample
import torch
import yaml
from easydict import EasyDict as edict

GRIPPER_PC = np.load('grasping/pytorch_6dof_graspnet/gripper_models/panda_pc.npy',
...
def get_control_point_tensor(batch_size, use_torch=True, device="cpu"):
    ...
    """
    control_points = np.load('./grasping/pytorch_6dof_graspnet/gripper_control_points/panda.npy')[:, :3]
